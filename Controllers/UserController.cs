...
namespace WebApp1.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,firstname,lastname,username,password")] tb_user tb_user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,firstname,lastname,username,password")] tb_user tb_user)
        {
            if (ModelState.IsValid)
            {
